      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-xl bg-white p-8 shadow-md">
            ...
            {/* Status Badge */}
            <span className="inline-flex rounded-full bg-green-50 px-3 py-1.5 text-sm font-medium capitalize text-green-700 ring-1 ring-inset ring-green-600/20">
              {product.status}
            </span>
                  ...
                  <p className="mt-1 text-xs text-gray-600">
                    ...
                    {(() => {
                      ...
                      if (selectedPeriod.discount_type === "percent") {
                        discountedPrice =
                          totalPrice -
                          (totalPrice * selectedPeriod.amount) / 100;
